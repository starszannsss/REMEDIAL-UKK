            ...
            <div class="bg-white dark:bg-gray-900 shadow-sm rounded-md border border-gray-200 dark:border-gray-800 overflow-hidden">
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.suplier.store') }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                <label for="id_suplier" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">ID Supplier</label>
                                <input type="text" 
                                       name="id_suplier" 
                                       id="id_suplier" 
                                ...
                                @enderror
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">Format: SP + 2 digit angka</p>
                            </div>
