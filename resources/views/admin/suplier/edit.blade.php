            ...
            <div class="bg-white dark:bg-gray-900 shadow-sm rounded-md border border-gray-200 dark:border-gray-800 overflow-hidden">
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.suplier.update', $suplier->id_suplier) }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">ID Supplier</label>
                                <input type="text" 
                                       value="{{ $suplier->id_suplier }}"
                                       class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 bg-gray-100 cursor-not-allowed"
                                       disabled>
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">ID Supplier tidak dapat diubah</p>
                            </div>

                            <div>
                                <label for="nama" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nama Supplier</label>
                                <input type="text" 
                                       name="nama" 
                                       id="nama" 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="kota" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Kota</label>
                                    <input type="text" 
                                           name="kota" 
                                           id="kota" 
