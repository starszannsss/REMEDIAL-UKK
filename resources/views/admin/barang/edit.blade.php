            ...
            <div class="bg-white dark:bg-gray-900 shadow-sm rounded-md border border-gray-200 dark:border-gray-800 overflow-hidden">
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.barang.update', $barang->id_barang) }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">ID Barang</label>
                                <input type="text" 
                                       ...
                                       disabled>
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">ID Barang tidak dapat diubah</p>
                            </div>
